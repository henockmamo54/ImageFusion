...
parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter, description='Performs Spatial/Temporal/Band Subsetting, Processing, and Customized Exporting for HLS V1.5 files')
...
shortname = {'HLSS30': 'HLSS30.v1.5', 'HLSL30': 'HLSL30.v1.5'}   
