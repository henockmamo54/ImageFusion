...
for root, dirs, files in os.walk(path):
    ...
    for file in files:
        ...
        # gdalscript="gdal_translate -projwin "+left_upper_lon+" "+left_upper_lat+" "+right_lower_lon+" "+right_lower_lat+" -of GTiff "+ (pathoutput+file).replace('.nc','.tif') + " "+(path_ROI+file).replace('.nc','.tif')
