# -*- coding: utf-8 -*-
"""
Created on Thu May 13 10:45:18 2021
...
path="D:\Workplace\githubProjects\ImageFusion\GK2A\\test\\"
...
for root, dirs, files in os.walk(path):
    ...
    for key in keys:
        ...
        if(elementcount == 24):
            ...
            datadict[_key]["Files"]= list( set(correctvalues) - set(datadict[_key]["Files"]) )
            datadict[_key]["count"] = len(datadict[_key]["Files"])
