# -*- coding: utf-8 -*-
"""
Created on Tue Apr 13 16:28:21 2021
...
while date <= enddate:
    ...
    print(date)       
    temp=str(date).replace(':','').replace('-','').replace(' ','')
    
    # url = "http://api.nmsc.kma.go.kr:9080/api/GK2A/LE1B/VI004/KO/data?key=NMSC26280a3e24eb4986a669f82b906e3c7f&date={0}".format(temp)
    url = "http://api.nmsc.kma.go.kr:9080/api/GK2A/LE1B/VI004/KO/data?date=202104110000&key=NMSC26280a3e24eb4986a669f82b906e3c7f"
    # print(url)
    cmd=('wget -P {0} {1}  '.format(path,url))
    print(cmd)
    # os.system(cmd)
