...
path ="/bess19/Image_fusion/pre_process/GK2A/CroppedConvertedTo_nc/VI008/"  
pathoutput="/bess19/Image_fusion/pre_process/GK2A/projected/VI008/" 
path_ROI ="/bess19/Image_fusion/pre_process/GK2A/ROI/VI008/"  
path_Reprojected ="/bess19/Image_fusion/pre_process/GK2A/Reprojected/VI008/"  
...
if not os.path.exists(pathoutput):
    os.makedirs("/bess19/Image_fusion/pre_process/GK2A/projected/VI008/")
    
if not os.path.exists(path_ROI):
    os.makedirs("/bess19/Image_fusion/pre_process/GK2A/ROI/VI008/")
