# -*- coding: utf-8 -*-
"""
Created on Tue Jun  1 21:10:09 2021
...
python croppoing.py 38.22346787684907 127.21710138948873 38.18195837298332 127.27222505323994
...
left_upper_lat=sys.argv[1]
left_upper_lon=sys.argv[2]
right_lower_lat=sys.argv[3]
right_lower_lon=sys.argv[4]
...
for root, dirs, files in os.walk(path):
    ...
    for file in files:
        ...
        # left_upper_lat=60.728965
        # left_upper_lon=113.996417
        # right_lower_lat=9.312252
