# -*- coding: utf-8 -*-
"""
Created on Wed Jun  2 21:27:23 2021
...
# for lonindex, lonval in  enumerate(longitude_):
#     for latindex,latval in enumerate(latitude_):
#         query="lon== {0} and lat == {1} ".format(lonval,latval)
#         tempval=test.query(query ).val.reset_index(drop="True")
#         if(tempval.shape[0]>0):
#             print("test===>",val)
#             temp[lonindex,latindex]=tempval[0]
