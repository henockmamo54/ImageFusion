...
path='/bess19/Image_fusion/pre_process/GK2A/Cropped/VI005/'
pathoutput = '/bess19/Image_fusion/pre_process/GK2A/CroppedConvertedTo_nc/VI005/'



if not os.path.exists(pathoutput):
    os.makedirs("/bess19/Image_fusion/pre_process/GK2A/CroppedConvertedTo_nc/VI005/")
