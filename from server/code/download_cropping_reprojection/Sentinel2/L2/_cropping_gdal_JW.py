...
path ="/bess19/Image_fusion/pre_process/Sentinel2/Registration"  
pathoutput="/bess19/Image_fusion/pre_process/Sentinel2/Cropped/L2" 
if not os.path.exists(pathoutput):
    os.makedirs("/bess19/Image_fusion/pre_process/Sentinel2/Cropped/L2")
