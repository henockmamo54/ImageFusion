...
if not os.path.exists("/bess19/Image_fusion/pre_process/GK2A/RAD/VI004/"):
     os.mkdir("/bess19/Image_fusion/pre_process/GK2A/RAD/VI004/")
...
for input_ncfile_path, output_txt_path, output_npy_path in zip(input_ncfile_paths, output_txt_paths, output_npy_paths):
    try:
        ...
        os.chdir('/bess19/Image_fusion/pre_process/GK2A/RAD/VI004')
