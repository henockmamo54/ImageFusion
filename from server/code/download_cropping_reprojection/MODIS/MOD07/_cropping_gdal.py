...
path ="/bess19/Image_fusion/pre_process/MODIS/MOD07/Stitched/"   
pathoutput="/bess19/Image_fusion/pre_process/MODIS/MOD07/Cropped/" 

if not os.path.exists(pathoutput):
    os.makedirs("/bess19/Image_fusion/pre_process/MODIS/MOD07/Cropped/")
