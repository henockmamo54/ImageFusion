...
path ="/bess19/Image_fusion/pre_process/MODIS/MOD05/Cropped/"  
pathoutput="/bess19/Image_fusion/pre_process/MODIS/MOD05/Reprojected/" 
 
if not os.path.exists(pathoutput):
    os.makedirs("/bess19/Image_fusion/pre_process/MODIS/MOD05/Reprojected/")
