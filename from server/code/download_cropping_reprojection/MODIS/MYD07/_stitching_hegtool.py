...
pathHeader ="/bess19/Image_fusion/pre_process/MODIS/MYD07/Header"
OBJECT_NAME = "mod07"
FIELD_NAME = "Total_Ozone"
PIXELSIZE = 1000.0
pathoutput="/bess19/Image_fusion/pre_process/MODIS/MYD07/Stitched" 

FIELD_NAMEs=["Total_Ozone","Water_Vapor"]

if not os.path.exists(pathoutput):
    os.makedirs("/bess19/Image_fusion/pre_process/MODIS/MYD07/Stitched")
...
# prepare the parameter file
    ...
    OUTPUT_STITCHED_FILENAME = D:/Workplace/githubProjects/ImageFusion/MODIS/ReprojectionCropping/TestData/MYD07_L2.A2019222.1320.061.2019223011051_mod07_stitched_.hdf
    OUTPUT_TYPE = GEO
    END
    ...
    originalfileinfo[0],originalfileinfo[1],originalfileinfo[2],originalfileinfo[3]) 
        ...
        os.system("/bess19/Image_fusion/code/HEGtool/bin/subset_stitch_swath -p /bess19/Image_fusion/code/download_cropping_reprojection/MODIS/MYD07/param.prm")
