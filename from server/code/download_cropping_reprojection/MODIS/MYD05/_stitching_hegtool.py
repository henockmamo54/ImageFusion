...
pathHeader ="/bess19/Image_fusion/pre_process/MODIS/MYD05/Header"
OBJECT_NAME = "mod05"
FIELD_NAME = "Total_Ozone"
PIXELSIZE = 1000.0
pathoutput="/bess19/Image_fusion/pre_process/MODIS/MYD05/Stitched" 

FIELD_NAMEs=["Water_Vapor_Near_Infrared"]

if not os.path.exists(pathoutput):
    os.makedirs("/bess19/Image_fusion/pre_process/MODIS/MYD05/Stitched")
...
# prepare the parameter file
    ...
    originalfileinfo[0],originalfileinfo[1],originalfileinfo[2],originalfileinfo[3]) 
        ...
        os.system("/bess19/Image_fusion/code/HEGtool/bin/subset_stitch_swath -p /bess19/Image_fusion/code/download_cropping_reprojection/MODIS/MYD05/param.prm")
