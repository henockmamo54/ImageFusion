...
path ="/bess19/Image_fusion/pre_process/MODIS/MCD43A4/Cropped/"  
pathoutput="/bess19/Image_fusion/pre_process/MODIS/MCD43A4/Reprojected/" 

if not os.path.exists(pathoutput):
    os.makedirs("/bess19/Image_fusion/pre_process/MODIS/MCD43A4/Reprojected/")
