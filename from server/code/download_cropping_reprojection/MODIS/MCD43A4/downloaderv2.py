...
os.system("cd /bess19/Image_fusion/download/MODIS/MCD43A4")

path = os.path.join("/bess19/Image_fusion/download/MODIS/MCD43A4",str(startdate_obj.year))
...
for p in products:
    ...
    cmd=('wget  --user hiik324 --password Ecology123 {0} --header "Authorization: Bearer C88B2F44-881A-11E9-B4DB-D7883D88392C" -P /bess19/Image_fusion/download/MODIS/MCD43A4/2019 '.format( url, path))
    os.system(cmd)
