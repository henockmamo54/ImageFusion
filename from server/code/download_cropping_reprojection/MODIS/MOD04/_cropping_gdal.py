...
path ="/bess19/Image_fusion/pre_process/MODIS/MOD04/Stitched/"   
pathoutput="/bess19/Image_fusion/pre_process/MODIS/MOD04/Cropped/" 

if not os.path.exists(pathoutput):
    os.makedirs("/bess19/Image_fusion/pre_process/MODIS/MOD04/Cropped/")
