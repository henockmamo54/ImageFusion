...
if not os.path.exists("/bess19/Image_fusion/download/GK2A/Angle/"):
     os.mkdir("/bess19/Image_fusion/download/GK2A/Angle")
...
for year in years:
    for jday in jdays:
        for hour in hours:
            ...
            os.chdir('/bess19/Image_fusion/download/GK2A/Angle')
            temp= "GK2A_ANGLE_{0}{1}{2:.2f}".format(year,jday,hour)
            savemat(temp + '_%03d.mat' % (n+4958) , mdict={'SZA': a})
