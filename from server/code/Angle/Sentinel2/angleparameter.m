...
for i = 1:size(list_B02,1)
    ...
    cd '/bess19/Image_fusion/download/Sentinel2/Angle/S2_ANGLE_RESULT';
    sprintf(savefilename,'/bess19/Image_fusion/download/Sentinel2/Angle/S2_ANGLE_RESULT')
    save(sprintf(savefilename,'/bess19/Image_fusion/download/Sentinel2/Angle/S2_ANGLE_RESULT'),'S2_ang');
    disp(i+"_finish");
